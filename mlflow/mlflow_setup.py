...
class MLflowSetup:
    ...
    def create_experiments(self) -> Dict[str, str]:
        ...
        try:
            ...
            print(f"✅ Created 'load-forecasting' experiment (ID: {load_forecasting_exp})")
        except Exception as e:
            # Experiment might already exist
            exp = mlflow.get_experiment_by_name("load-forecasting")
            if exp:
                experiments["load-forecasting"] = exp.experiment_id
                print(f"ℹ️  'load-forecasting' experiment already exists (ID: {exp.experiment_id})")
            else:
        ...
        try:
            ...
            if exp:
                ...
                print(f"ℹ️  'anomaly-detection' experiment already exists (ID: {exp.experiment_id})")
            else:
